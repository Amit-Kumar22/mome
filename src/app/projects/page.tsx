...
export default function ProjectsPage() {
  return (
    <div className="min-h-screen bg-gradient-light-theme">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto mb-12">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 slide-up">
            <span className="text-yen-gradient">Our</span> <span className="text-yen-purple">Success Stories</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {staticProjects.map((project) => (
            <Card key={project.id} className="bg-white/60 backdrop-blur-sm shadow-theme hover:shadow-lg transition-all slide-up">
              <CardHeader>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-purple-pink">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/contact">
            <Button size="lg" variant="secondary" className="btn-hover-glow bg-white text-yen-purple hover:bg-gray-100 border-0">
              Get in Touch
            </Button>
          </Link>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-yen-purple text-white py-8">
        <div className="container mx-auto px-4 text-center">
